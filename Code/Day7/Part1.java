...
public class Part1 {
    ...
    public static String[][] getInput() {
        ...
        ArrayList<String> lines = Input.getLines(new File("Code/Day7/input.txt"));
        for(String line : lines) {
            hand.add(line.split(" "));
        }

        String[][] handArr = new String[hand.size()][2];
